...
#Cargar los datos
path = '/content/drive/MyDrive/CursoIA_Chatbot/intents.json'
...
model.add(Dense(8, activation= 'relu'))  #Las salidas de la capa densa 1 son los que van a capa densa 2
